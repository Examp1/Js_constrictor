...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  // extends = наследуем от класса блок
  function TitleBlock(value, options) {
    _classCallCheck(this, TitleBlock);

    return _super.call(this, value, options); //super = инициализация конструктора родителя
  }
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHtml() {
      ...
      return (0, _util.row)((0, _util.col)("<".concat(tag, ">").concat(this.value, "</").concat(tag, ">")), (0, _util.css)(styles));
    }
  }]);
...
var ImageBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHtml() {
      ...
      return (0, _util.row)("<img src=\"".concat(this.value, "\" alt=\"").concat(alt, "\" style=\"").concat((0, _util.css)(is), "\" />"), (0, _util.css)(this.options.styles));
    }
  }]);
...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    key: "toHtml",
    value: function toHtml() {
      var html = this.value.map(_util.col).join('');
      return (0, _util.row)(html, (0, _util.css)(this.options.styles));
    }
  }]);
...
var TextBlock = /*#__PURE__*/function (_Block4) {
  ...
  _createClass(TextBlock, [{
    key: "toHtml",
    value: function toHtml() {
      return (0, _util.row)((0, _util.col)("<p>".concat(this.value, "</p>")), (0, _util.css)(this.options.styles));
    }
  }]);
...
},{"../util":"util.js"}],"model.js":[function(require,module,exports) {
"use strict";
...
}), new _block.TextBlock('Это текст блок', {
  styles: {
    background: 'tomato'
  }
}), new _block.ColumnsBlock(['Колонка 1', 'Колонка 2', 'Колонка 3'], {
  styles: {
...
var Sidebar = /*#__PURE__*/function () {
  ...
  _createClass(Sidebar, [{
    ...
    value: function init() {
      ...
      this.$el.addEventListener('submit', this.add.bind(this)); // bind this привязывает контекст к классу чтобы не было проблем
    }
  }, {
    key: "add",
    ...
    key: "template",
    get: function get() {
      return [(0, _util.block)('text'), (0, _util.block)('title')].join('');
    }
  }]);
...
},{"../util":"util.js","./block":"classes/block.js"}],"classes/app.js":[function(require,module,exports) {
"use strict";
...
new _sidebar.Sidebar('#panel', updateCallback); // TODO app fix
// new App(model)
},{"./model":"model.js","./classes/site":"classes/site.js","./classes/sidebar":"classes/sidebar.js","./classes/app":"classes/app.js","./style/main.css":"style/main.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
